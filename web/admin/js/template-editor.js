...
const BLOCK_DESCRIPTIONS = {
  ...
  heading_formatting: 'Шрифт, кегль, полужирность и выравнивание заголовков',
  page_numbering: 'Наличие и расположение нумерации страниц',
  section_breaks: 'Каждый основной раздел начинается с новой страницы',
  toc: 'Наличие автоматического оглавления в документе',
  captions: 'Формат подписей к рисункам и таблицам',
  list_formatting: 'Обнаружение и исправление неоформленных списков',
...
const PARAM_LABELS = {
  ...
  normalize_margins: 'Исправлять поля страницы',
  normalize_headings: 'Исправлять заголовки',
  normalize_table_width: 'Исправлять ширину таблиц',
  normalize_font_color: 'Исправлять цвет текста',
  target_font_color: 'Целевой цвет (HEX)',
  remove_italic: 'Убирать курсив',
  normalize_list_indent: 'Убирать отступ списков',
  normalize_list_markers: 'Маркеры списков в тире',
  list_marker_char: 'Символ маркера списка',
  convert_informal_lists: 'Оформлять неоформленные списки',
  normalize_dashes: 'Длинные тире в короткие',
  informal_list_markers: 'Символы-маркеры неоформленных списков',
  min_consecutive: 'Минимум подряд идущих элементов для определения списка',
  remove_caption_trailing_dot: 'Убирать точку в подписях',
...
const PARAM_HINTS = {
  ...
  position: 'Расположение номера страницы в колонтитуле',
  normalize_margins: 'Нормализует поля страницы по ГОСТу. Может сломать вёрстку таблиц',
  normalize_headings: 'Нормализует шрифт, кегль и полужирность заголовков',
  normalize_table_width: 'Приводит ширину таблиц к области текста при переполнении',
  ...
  normalize_font_color: 'Устанавливает чёрный цвет для всего текста, включая заголовки и оглавление',
  target_font_color: 'HEX-код целевого цвета (000000 = чёрный)',
  remove_italic: 'Удаляет курсивное начертание по ГОСТ',
  normalize_list_indent: 'Убирает красную строку и отступ у элементов списка',
  normalize_list_markers: 'Заменяет маркеры-кружочки и прочие символы на тире',
  list_marker_char: 'Символ маркера для списка. По умолчанию — длинное тире (—)',
  convert_informal_lists: 'Если в тексте 2+ подряд идущих абзаца начинаются с маркера (*, ·, •, - и т.д.), система оформит их в список',
  normalize_dashes: 'Заменяет длинные тире на короткие (кроме перечислений)',
  informal_list_markers: 'Символы, которые указывают на неоформленный список (·, •, *, -, —, –). Можно дополнять',
  min_consecutive: 'Сколько подряд идущих строк с маркером нужно, чтобы система считала их списком. Обычно 2',
  remove_caption_trailing_dot: 'Убирает точку в конце подписей рисунков и таблиц',
