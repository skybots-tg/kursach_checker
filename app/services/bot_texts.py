...
SYSTEM_TEXTS: dict[str, dict[str, Any]] = {
    "bot.welcome": {
        ...
        "default": (
            "Привет! 👋\n\n"
            "Я помогу проверить оформление курсовой или ВКР "
            "по ГОСТу и методичке вашего вуза.\n\n"
            "Просто отправьте мне файл в формате DOC или DOCX."
        ),
        "supports_html": False,
        "variables": [],
    },
    ...
    "check.no_credits": {
        ...
        "default": "К сожалению, у вас не осталось проверок 😔\nПополните баланс в профиле, чтобы продолжить.",
        "supports_html": False,
        "variables": [],
    },
    "check.no_templates": {
    ...
    "notify.check_done": {
        ...
        "group": "Уведомления",
        "description": "Отправляется после завершения проверки через воркер",
        "default": (
            "✅ <b>Проверка завершена!</b>\n\n"
            "Ваш документ проверен. Откройте приложение, "
            "чтобы посмотреть подробный отчёт и скачать исправленный файл."
        ),
        "supports_html": True,
        "variables": ["check_id"],
    },
