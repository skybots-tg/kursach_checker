...
_LEVEL1_RE = re.compile(
    ...
    r"|список\s+(?:литературы|использованн\w*\s+(?:источников|литературы)"
    r"|используем\w*\s+(?:источников|литературы)"
    r"|информационных\s+источников"
    r"|использованн\w*\s+источников\s+и\s+литературы"
    r"|используем\w*\s+источников\s+и\s+литературы"
