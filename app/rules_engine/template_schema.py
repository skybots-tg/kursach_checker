...
DEFAULT_TEMPLATE_BLOCKS: list[RuleBlock] = [
    ...
    RuleBlock(
        key="heading_semantics",
        title="Семантика и иерархия заголовков",
        severity="warning",
        params={
            "detect_numbered_headings": True,
            "require_word_heading_styles": True,
            "require_standalone_heading_paragraph": True,
            "require_no_first_line_indent": True,
            "require_non_justified_alignment": True,
